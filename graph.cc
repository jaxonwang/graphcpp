...
class Graph {
   ...
   public:
    ...
    void add_node_attr(const K &key, const string &attr_name,
                       boost::any &value);
...
template <class K>
void Graph<K>::init_adjlist(const K &key) {
...
template <class K>
void Graph<K>::add_node(const K &key) {
...
template <class K>
boost::any Graph<K>::get_edge_attr(const K &from, const K &to,
                                   const string &key) {
...
template <class K>
void Graph<K>::add_edge_attr(const K &from, const K &to,
                             const string &attr_name, boost::any &value) {
    pair<K, K> np{from, to};
